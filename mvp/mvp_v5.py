...
OUTPUT_PATH        = Path("out_hybrid.ndjson.gz")
...
USE_KOE5_TOKENIZER = True  

openai.api_key = OPENAI_API_KEY

if USE_KOE5_TOKENIZER:
...
def build_eval_prompt():
    return {
        ...
        "content": (
            ...
            "4. If overall < 60 provide up to 3 improved English alternatives in ‘alternatives’; otherwise leave it empty.\n\n"
